...
"""
    ...
    def _write_creative_tab(self, root: Path, project: ModProject) -> None:
        ...
        w.add_import("net.neoforged.bus.api.IEventBus")
        w.add_import("net.neoforged.neoforge.registries.DeferredHolder")
        w.add_import("net.neoforged.neoforge.registries.DeferredRegister")
        w.line()
        ...
        w.line()
        w.line(f'public static final DeferredHolder<CreativeModeTab, CreativeModeTab> TAB = TABS.register("creative_tab",')

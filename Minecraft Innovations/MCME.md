...
|---------|-----------|-------|--------|
| GeoVox | `GeoVox/` | Real-world 3D data → Minecraft worlds | v0.1.1 |
| Minecraft Studio | `Minecraft Studio/` | Roblox Studio-style IDE for Minecraft modding | v0.2.0 -- Layer 1 complete |

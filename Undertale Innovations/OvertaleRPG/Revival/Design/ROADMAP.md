...
Status: **Phase 0 -- Setup complete, awaiting archive import**
...
- [ ] Create a master inventory spreadsheet/document of everything in the archive
...
### Phase 3: Scoping
- [ ] Define the revival scope (see SCOPE.md)
- [ ] Choose engine (see ENGINE.md)
...
**Get the Google Drive contents into Original Archive.** Nothing else can happen until the source material is accessible in version control.

# Revival Scope Document

Status: **Draft -- pending archive excavation**

This document defines what the OvertaleRPG revival includes and, more importantly, what it doesn't. To be filled in after the original archive has been fully cataloged and the GDD has been read cover to cover.
